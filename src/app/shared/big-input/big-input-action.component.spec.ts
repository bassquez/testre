...
describe('BigInputActionComponent', () => {
  ...
  const getLabel = () =>
    fixture.debugElement.query(By.css('.mat-flat-button-wrapper > span'));
  ...
  it('should be created', () => {
    const template = '<gp-big-input-action></gp-big-input-action>';
  ...
  it('should disable button if disabled property is set', () => {
    const template =
      '<gp-big-input-action [disabled]="true"></gp-big-input-action>';
    fixture = createHostComponent(template);
    expect(getButton().nativeElement.disabled).toBeTruthy();
  });

  it('should display icon if fontSet and fontIcon properties are set', () => {
    const template = `<gp-big-input-action fontSet="fas" fontIcon="fa-trash"></gp-big-input-action>`;
    fixture = createHostComponent(template);
  ...
  it('should display label with provided text when label property is set', () => {
    const template = `<gp-big-input-action label="delete"></gp-big-input-action>`;
    fixture = createHostComponent(template);
  ...
  it('should emit action event on button click', () => {
    const template = `<gp-big-input-action (action)="actionHandler()"></gp-big-input-action>`;
    fixture = createHostComponent(template);
